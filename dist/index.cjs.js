  ...
  _createClass(NodeRendererDefault, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          _this$props.treeId;
          _this$props.isOver;
          _this$props.parentNode;
          var rowDirection = _this$props.rowDirection,
      ...
      if (canDrag) {
        if (typeof node.children === 'function' && node.expanded) {
          ...
          handle = /*#__PURE__*/React__default['default'].createElement("div", {
          ...
          handle = connectDragSource( /*#__PURE__*/React__default['default'].createElement("div", {
      ...
      return /*#__PURE__*/React__default['default'].createElement("div", _extends({
      ...
      }, otherProps), toggleChildrenVisibility && node.children && (node.children.length > 0 || typeof node.children === 'function') && /*#__PURE__*/React__default['default'].createElement("div", null, /*#__PURE__*/React__default['default'].createElement("button", {
        type: "button",
      ...
      }), node.expanded && !isDragging && /*#__PURE__*/React__default['default'].createElement("div", {
        style: {
      ...
      }, connectDragPreview( /*#__PURE__*/React__default['default'].createElement("div", {
        ...
        path: path,
        treeIndex: treeIndex
      }) : nodeTitle), nodeSubtitle && /*#__PURE__*/React__default['default'].createElement("span", {
        className: "rst__rowSubtitle"
      }, typeof nodeSubtitle === 'function' ? nodeSubtitle({
        node: node,
        path: path,
        treeIndex: treeIndex
      }) : nodeSubtitle)), /*#__PURE__*/React__default['default'].createElement("div", {
...
NodeRendererDefault.propTypes = {
  node: PropTypes__default['default'].shape({}).isRequired,
  title: PropTypes__default['default'].oneOfType([PropTypes__default['default'].func, PropTypes__default['default'].node]),
  subtitle: PropTypes__default['default'].oneOfType([PropTypes__default['default'].func, PropTypes__default['default'].node]),
  path: PropTypes__default['default'].arrayOf(PropTypes__default['default'].oneOfType([PropTypes__default['default'].string, PropTypes__default['default'].number])).isRequired,
  treeIndex: PropTypes__default['default'].number.isRequired,
  treeId: PropTypes__default['default'].string.isRequired,
  isSearchMatch: PropTypes__default['default'].bool,
  isSearchFocus: PropTypes__default['default'].bool,
  canDrag: PropTypes__default['default'].bool,
  scaffoldBlockPxWidth: PropTypes__default['default'].number.isRequired,
  toggleChildrenVisibility: PropTypes__default['default'].func,
  ...
  parentNode: PropTypes__default['default'].shape({}),
  // Needed for dndManager
  isDragging: PropTypes__default['default'].bool.isRequired,
  didDrop: PropTypes__default['default'].bool.isRequired,
  draggedNode: PropTypes__default['default'].shape({}),
  // Drop target
  isOver: PropTypes__default['default'].bool.isRequired,
  canDrop: PropTypes__default['default'].bool,
  // rtl support
  rowDirection: PropTypes__default['default'].string
};
  ...
  _createClass(TreeNode, [{
    ...
    value: function render() {
      ...
      lowerSiblingCounts.forEach(function (lowerSiblingCount, i) {
        ...
        scaffold.push( /*#__PURE__*/React__default['default'].createElement("div", {
          key: "pre_".concat(1 + i),
          style: {
            width: scaffoldBlockPxWidth
          },
      ...
      return connectDropTarget( /*#__PURE__*/React__default['default'].createElement("div", _extends({}, otherProps, {
        className: classnames('rst__node', rowDirectionClass)
      }), scaffold, /*#__PURE__*/React__default['default'].createElement("div", {
...
TreeNode.propTypes = {
  treeIndex: PropTypes__default['default'].number.isRequired,
  treeId: PropTypes__default['default'].string.isRequired,
  swapFrom: PropTypes__default['default'].number,
  swapDepth: PropTypes__default['default'].number,
  swapLength: PropTypes__default['default'].number,
  scaffoldBlockPxWidth: PropTypes__default['default'].number.isRequired,
  lowerSiblingCounts: PropTypes__default['default'].arrayOf(PropTypes__default['default'].number).isRequired,
  listIndex: PropTypes__default['default'].number.isRequired,
  ...
  draggedNode: PropTypes__default['default'].shape({}),
  // used in dndManager
  getPrevRow: PropTypes__default['default'].func.isRequired,
  node: PropTypes__default['default'].shape({}).isRequired,
  path: PropTypes__default['default'].arrayOf(PropTypes__default['default'].oneOfType([PropTypes__default['default'].string, PropTypes__default['default'].number])).isRequired,
  // rtl support
  rowDirection: PropTypes__default['default'].string
  ...
  _createClass(TreePlaceholder, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          _this$props.treeId;
          _this$props.drop;
          var otherProps = _objectWithoutProperties(_this$props, ["children", "connectDropTarget", "treeId", "drop"]);

      return connectDropTarget( /*#__PURE__*/React__default['default'].createElement("div", null, React.Children.map(children, function (child) {
...
TreePlaceholder.propTypes = {
  ...
  draggedNode: PropTypes__default['default'].shape({}),
  treeId: PropTypes__default['default'].string.isRequired,
  drop: PropTypes__default['default'].func.isRequired
};
...
var ReactSortableTree = /*#__PURE__*/function (_Component) {
  ...
  function ReactSortableTree(props) {
    ...
    if (isVirtualized) {
      _this.scrollZoneVirtualList = (withScrolling.createScrollingComponent || withScrolling__default['default'])(reactVirtualized.List);
  ...
  _createClass(ReactSortableTree, [{
    ...
    value: function renderRow(row, _ref9) {
      ...
      return /*#__PURE__*/React__default['default'].createElement(TreeNodeRenderer, _extends({
        style: style,
        key: nodeKey,
        listIndex: listIndex,
        ...
        swapDepth: swapDepth
      }, sharedProps), /*#__PURE__*/React__default['default'].createElement(NodeContentRenderer, _extends({
        parentNode: parentNode,
        isSearchMatch: isSearchMatch,
        isSearchFocus: isSearchFocus,
        canDrag: rowCanDrag,
    ...
    value: function render() {
      ...
      if (rows.length < 1) {
        ...
        list = /*#__PURE__*/React__default['default'].createElement(Placeholder, {
          treeId: this.treeId,
          drop: this.drop
        }, /*#__PURE__*/React__default['default'].createElement(PlaceholderContent, null));
        ...
        list = /*#__PURE__*/React__default['default'].createElement(reactVirtualized.AutoSizer, null, function (_ref11) {
          var height = _ref11.height,
              width = _ref11.width;
          return /*#__PURE__*/React__default['default'].createElement(ScrollZoneVirtualList, _extends({}, scrollToInfo, {
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      ...
      var newState = {};
      var isTreeDataEqual = isEqual__default['default'](instanceProps.treeData, nextProps.treeData); // make sure we have the most recent version of treeData
...
ReactSortableTree.propTypes = {
  dragDropManager: PropTypes__default['default'].shape({
    getMonitor: PropTypes__default['default'].func
  }).isRequired,
  ...
  treeData: PropTypes__default['default'].arrayOf(PropTypes__default['default'].object).isRequired,
  // Style applied to the container wrapping the tree (style defaults to {height: '100%'})
  style: PropTypes__default['default'].shape({}),
  // Class name for the container wrapping the tree
  className: PropTypes__default['default'].string,
  // Style applied to the inner, scrollable container (for padding, etc.)
  innerStyle: PropTypes__default['default'].shape({}),
  // Used by react-virtualized
  // Either a fixed row height (number) or a function that returns the
  // height of a row given its index: `({ index: number }): number`
  rowHeight: PropTypes__default['default'].oneOfType([PropTypes__default['default'].number, PropTypes__default['default'].func]),
  // Size in px of the region near the edges that initiates scrolling on dragover
  slideRegionSize: PropTypes__default['default'].number,
  // Custom properties to hand to the react-virtualized list
  // https://github.com/bvaughn/react-virtualized/blob/master/docs/List.md#prop-types
  reactVirtualizedListProps: PropTypes__default['default'].shape({}),
  // The width of the blocks containing the lines representing the structure of the tree.
  scaffoldBlockPxWidth: PropTypes__default['default'].number,
  // Maximum depth nodes can be inserted at. Defaults to infinite.
  maxDepth: PropTypes__default['default'].number,
  // The method used to search nodes.
  // Defaults to a function that uses the `searchQuery` string to search for nodes with
  // matching `title` or `subtitle` values.
  // NOTE: Changing `searchMethod` will not update the search, but changing the `searchQuery` will.
  searchMethod: PropTypes__default['default'].func,
  // Used by the `searchMethod` to highlight and scroll to matched nodes.
  // Should be a string for the default `searchMethod`, but can be anything when using a custom search.
  searchQuery: PropTypes__default['default'].any,
  // eslint-disable-line react/forbid-prop-types
  // Outline the <`searchFocusOffset`>th node and scroll to it.
  searchFocusOffset: PropTypes__default['default'].number,
  // Get the nodes that match the search criteria. Used for counting total matches, etc.
  searchFinishCallback: PropTypes__default['default'].func,
  // Generate an object with additional props to be passed to the node renderer.
  // Use this for adding buttons via the `buttons` key,
  // or additional `style` / `className` settings.
  generateNodeProps: PropTypes__default['default'].func,
  // Set to false to disable virtualization.
  // NOTE: Auto-scrolling while dragging, and scrolling to the `searchFocusOffset` will be disabled.
  isVirtualized: PropTypes__default['default'].bool,
  treeNodeRenderer: PropTypes__default['default'].func,
  // Override the default component for rendering nodes (but keep the scaffolding generator)
  // This is an advanced option for complete customization of the appearance.
  // It is best to copy the component in `node-renderer-default.js` to use as a base, and customize as needed.
  nodeContentRenderer: PropTypes__default['default'].func,
  ...
  placeholderRenderer: PropTypes__default['default'].func,
  ...
  getNodeKey: PropTypes__default['default'].func,
  // Called whenever tree data changed.
  // Just like with React input elements, you have to update your
  // own component's data to see the changes reflected.
  onChange: PropTypes__default['default'].func.isRequired,
  // Called after node move operation.
  onMoveNode: PropTypes__default['default'].func,
  // Determine whether a node can be dragged. Set to false to disable dragging on all nodes.
  canDrag: PropTypes__default['default'].oneOfType([PropTypes__default['default'].func, PropTypes__default['default'].bool]),
  // Determine whether a node can be dropped based on its path and parents'.
  canDrop: PropTypes__default['default'].func,
  // Determine whether a node can have children
  canNodeHaveChildren: PropTypes__default['default'].func,
  // When true, or a callback returning true, dropping nodes to react-dnd
  // drop targets outside of this tree will not remove them from this tree
  shouldCopyOnOutsideDrop: PropTypes__default['default'].oneOfType([PropTypes__default['default'].func, PropTypes__default['default'].bool]),
  // Called after children nodes collapsed or expanded.
  onVisibilityToggle: PropTypes__default['default'].func,
  dndType: PropTypes__default['default'].string,
  // Called to track between dropped and dragging
  onDragStateChanged: PropTypes__default['default'].func,
  // Specify that nodes that do not match search will be collapsed
  onlyExpandSearchedNodes: PropTypes__default['default'].bool,
  // rtl support
  rowDirection: PropTypes__default['default'].string
};
...
var SortableTreeWithoutDndContext = function SortableTreeWithoutDndContext(props) {
  return /*#__PURE__*/React__default['default'].createElement(reactDnd.DndContext.Consumer, null, function (_ref17) {
    var dragDropManager = _ref17.dragDropManager;
    return dragDropManager === undefined ? null : /*#__PURE__*/React__default['default'].createElement(ReactSortableTree, _extends({}, props, {
      dragDropManager: dragDropManager
    }));
  });
};
...
var SortableTree = function SortableTree(props) {
  ...
  }, /*#__PURE__*/React__default['default'].createElement(SortableTreeWithoutDndContext, props));
